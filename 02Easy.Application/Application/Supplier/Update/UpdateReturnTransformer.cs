...
namespace Easy.Application.Application.Supplier.Update
{
    public class UpdateReturnTransformer:AppReturnTransFormer
    {
        public override dynamic GetValue(Domain.Application.ReturnContext context, object data)
        {
            ...
            return new Result(ResultStatus.Ok.GetHashCode());
        }
    }
}
